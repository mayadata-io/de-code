    ...
    <div class="card col-4 p-3">
        <div class="card-body p-0 d-flex align-items-center">
          ...
          <div class="pl-3">
              ...
              <p class="mb-0">MALFUNCTIONING OPENEBS COMPONENTS</p>
          </div>
        </div>
    </div>
    <div class="card col-4 p-3">
        <div class="card-body p-0 d-flex align-items-center">
          ...
          <div class="pl-3">
              ...
              <p class="mb-0">VOLUMES NEED YOUR ATTENTION</p>
          </div>
        </div>
    </div>
    <div class="card col-4 p-3">
        <div class="card-body p-0 d-flex align-items-center">
          ...
          <div class="pl-3">
              ...
              <p class="mb-0">MALFUNCTIONING DO COMPONENTS</p>
          </div>
        </div>
    </div>
</div>
...
<div class="d-flex flex-row align-items-center justify-content-between flex-wrap card-deck">
    ...
    <div class="card col p-4">
        <div class="card-body p-0">
            ...
            <p class="mb-0">Healthy Volumes</p>
        </div>
    </div>
    <div class="card col p-4">
        <div class="card-body p-0">
            ...
            <p class="mb-0">Unhealthy Volumes</p>
        </div>
    </div>
</div>
</Playground>