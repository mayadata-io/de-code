...
i&&i.destroy()}},e.prototype.destroy=function(){this.isDestroying=!0,this.destroyCache(this._namespaces.adapter),this.destroyCache(this._namespaces.serializer),this.isDestroyed=!0},e.prototype.toString=function(){return"ContainerInstanceCache"},e}(),jt=Ember.A,Mt=Ember._Backburner,Nt=Ember.computed,Dt=Ember.copy,It=Ember.ENV,Ft=Ember.Error,Lt=Ember.get,zt=(Ember.inspect,Ember.isNone),qt=(Ember.isPresent,Ember.MapWithDefault),Ht=Ember.run,Bt=Ember.set,Ut=Ember.RSVP,Vt=Ember.Service,Wt=(Ember.typeOf,Ut.Promise)
...
if(r.reload)return Bt(t,"isUpdating",!0),u(ut(n,this,e,i,r))
var o=t._createSnapshot(r)
return n.shouldReloadAll(this,o)?(Bt(t,"isUpdating",!0),u(ut(n,this,e,i,r))):!1===r.backgroundReload?u(Wt.resolve(t)):((r.backgroundReload||n.shouldBackgroundReloadAll(this,o))&&(Bt(t,"isUpdating",!0),ut(n,this,e,i,r)),u(Wt.resolve(t)))},_didUpdateAll:function(e){this.recordArrayManager._didUpdateAll(e)},didUpdateAll:function(e){return this._didUpdateAll(e)},peekAll:function(e){var t=C(e)
return this.recordArrayManager.liveRecordArrayFor(t)},unloadAll:function(e){if(0===arguments.length)this._identityMap.clear()
else{var t=C(e)
this._internalModelsFor(t).clear()}},filter:function(e,t,r){It.ENABLE_DS_FILTER
...
e.flushChangedAttributes(),e.adapterWillCommit(),this._pendingSave.push({snapshot:n,resolver:t}),Ht.once(this,this.flushPendingSave)},flushPendingSave:function(){var e=this._pendingSave.slice()
this._pendingSave=[]
...
e.length=0},_updateInternalModel:function(e){1===this._updatedInternalModels.push(e)&&Ht.schedule("actions",this,this._flushUpdatedInternalModels)},_flushUpdatedInternalModels:function(){for(var e=this._updatedInternalModels,t=0,r=e.length;t<r;t++)e[t]._triggerDeferredTriggers()
